...
class Arguments(object):
    ...
    def get_arguments(self):
        ...
        create_parser.add_argument('image', action='store', choices=['kali-ami', 'offsec-server', 'phishing-server'], nargs='*', type=str, help='Machine Image you would like to create')
