...
class Command():
    ...
    def __init__(self, cmd='', devnull=False, stdout=s.PIPE, stderr=s.PIPE, cwd=None, bufsize=0, stdin=s.PIPE):
    ...
    def run(self, shell=False, universal_newlines=True):
        ...
        try:
            self.output = s.check_output(self.cmd, shell=False, stderr=s.STDOUT, universal_newlines=True)
